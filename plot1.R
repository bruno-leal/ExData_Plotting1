...
## The plot1 function draws a graph corresponding to the Plot 1 graph of the project.
plot1 <- function() {
...
## The png1 function uses the plot1 function to create a png with the Plot 1 graph of the project.
png1 <- function() {
    # Open png device.
    png(filename = "plot1.png", width = 480, height = 480, units = "px")
    
    # Create the graph using plot1 function.
    plot1()
